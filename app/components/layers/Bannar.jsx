...
const Bannar = () => {
  ...
  return (
    ...
    <Slider {...settings} className='cursor-pointer'>
      <div>
          <Image className="w-full" src={bannar01} alt="bannar01" />
      </div>
      <div>
        <Image className="w-full" src={bannar02} alt="bannar02" />
      </div>
      <div>
        <Image className="w-full" src={bannar03} alt="bannar03" />
      </div>
      <div>
        <Image className="w-full" src={bannar04} alt="bannar04" />
      </div>
    </Slider>
    </>
  )
